...
def _TestTaskArgumentDependencies_test_literal_argument_references_pass_in_both_dependency_phases(self):
    for declaration in [
...
def _TestTaskArgumentDependencies_test_argument_references_keep_unknown_cycle_and_shape_rejection(self):
...
def _TestTaskArgumentDependencies_test_standardization_preserves_argument_bytes_and_reading_order(self):
...
class TestTaskArgumentDependencies(unittest.TestCase):
    ...
    test_argument_instances_survive_runtime_edge_reduction = _TestTaskArgumentDependencies_test_argument_instances_survive_runtime_edge_reduction
    test_standardization_preserves_argument_bytes_and_reading_order = _TestTaskArgumentDependencies_test_standardization_preserves_argument_bytes_and_reading_order
