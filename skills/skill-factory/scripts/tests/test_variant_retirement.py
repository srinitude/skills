...
class TestVariantRetirement(unittest.TestCase):
    ...
    def reviewed(self, complete=True):
    ...
    def test_preview_names_exact_retirements_and_observed_dependency_order(self):
    ...
    def test_missing_retirement_review_rejects_without_effect(self):
    ...
    def test_reviewed_removal_reports_each_effect_and_preserves_independent_state(self):
    ...
    def test_retired_mode_drift_rejects_without_losing_the_edit(self):
    ...
    def test_actual_per_retirement_post_read_drift_restores_then_recovers(self):
