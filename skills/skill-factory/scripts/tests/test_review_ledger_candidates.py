...
class TestCandidateViews(unittest.TestCase):
    ...
    def test_all_four_modes_match_known_complete_two_position_spaces(self):
    ...
    def test_complete_small_spaces_match_independent_standard_iterators(self):
    ...
    def test_large_exact_rank_uses_its_declared_budget_without_prefix_rescanning(self):
    ...
    def test_unordered_pool_reordering_is_stable_but_meaningful_order_and_repeats_survive(self):
    ...
    def test_empty_and_zero_length_spaces_and_out_of_range_pages_are_truthful(self):
    ...
    def test_pair_pages_cover_every_subject_and_rule_only_space_without_acceptance(self):
    ...
    def test_selection_pages_join_exactly_and_reject_bad_bounds_members_and_budgets(self):
