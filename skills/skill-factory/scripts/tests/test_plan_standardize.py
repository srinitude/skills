...
def _TestPlanStandardizeReport_test_runtime_cache_files_are_excluded_from_baseline(self):
    with tempfile.TemporaryDirectory() as temp:
        root = Path(temp)
...
def _TestPlanStandardizeReport_test_runtime_links_do_not_block_the_plan(self):
    with tempfile.TemporaryDirectory() as temp:
        root = Path(temp)
...
def _TestPlanStandardizeReport_test_report_freezes_files_and_missing_standard_owners(self):
    with tempfile.TemporaryDirectory() as temp:
        root = Path(temp)
        (root / "SKILL.md").write_text("---\nname: demo\n---\n", encoding="utf-8")
...
def _TestPlanStandardizeReport_test_report_maps_host_specific_paths_to_portable_owners(self):
    with tempfile.TemporaryDirectory() as temp:
        root = Path(temp)
        (root / "SKILL.md").write_text("---\nname: demo\n---\n", encoding="utf-8")
...
def _TestPlanStandardizeReport_test_unknown_host_owner_fails_closed_in_plan(self):
    with tempfile.TemporaryDirectory() as temp:
        root = Path(temp)
        (root / "SKILL.md").write_text("---\nname: demo\n---\n", encoding="utf-8")
...
def _TestPlanStandardizeReport_test_symlinked_skill_root_fails_before_inventory(self):
    with tempfile.TemporaryDirectory() as temp:
        base = Path(temp)
        root = base / "demo"
        root.mkdir()
...
class TestPlanStandardizeReport(unittest.TestCase):
    test_runtime_cache_files_are_excluded_from_baseline = _TestPlanStandardizeReport_test_runtime_cache_files_are_excluded_from_baseline
    test_runtime_links_do_not_block_the_plan = _TestPlanStandardizeReport_test_runtime_links_do_not_block_the_plan
    test_report_freezes_files_and_missing_standard_owners = _TestPlanStandardizeReport_test_report_freezes_files_and_missing_standard_owners
    test_report_maps_host_specific_paths_to_portable_owners = _TestPlanStandardizeReport_test_report_maps_host_specific_paths_to_portable_owners
    test_unknown_host_owner_fails_closed_in_plan = _TestPlanStandardizeReport_test_unknown_host_owner_fails_closed_in_plan
    test_symlinked_skill_root_fails_before_inventory = _TestPlanStandardizeReport_test_symlinked_skill_root_fails_before_inventory
