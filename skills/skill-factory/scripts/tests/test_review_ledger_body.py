...
class TestBodyRevision(unittest.TestCase):
    ...
    def test_public_replacement_reads_old_and_new_bodies_and_preserves_mode(self):
    ...
    def test_wrong_previous_and_unfinished_review_reject_then_recover(self):
    ...
    def test_source_or_previous_snapshot_overlap_cannot_hide_behind_body_authority(self):
    ...
    def test_blank_invalid_or_missing_candidate_rejects_before_replacement(self):
    ...
    def test_revision_cannot_authorize_nonbody_or_case_alias_paths(self):
        self.revision(True); before = self.package()
    ...
    def assert_restores(self, replacing):
    ...
    def test_creation_restores_absence_after_post_write_source_drift(self):
        self.assert_restores(False)

    def test_replacement_restores_previous_body_after_post_write_source_drift(self):
