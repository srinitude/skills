...
CLI_SCRIPTS = ["check_code_rules.py", "check_decision_records.py", "check_domain_research.py", "check_evals.py", "check_improvement_contract.py", "check_invocation_receipt.py", "check_mise_primitives.py", "check_placeholders.py", "check_primitive_lifecycle.py", "check_task_graph.py", "check_use_case_contract.py", "lint_writing.py", "run_agentic_request.py", "sync_mise_primitives.py", "validate_result.py", "validate_skill.py"]
