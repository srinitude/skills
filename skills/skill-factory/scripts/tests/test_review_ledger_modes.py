...
class TestLedgerModes(unittest.TestCase):
    ...
    def test_creation_and_mode_only_replacement_use_the_native_route(self):
        case = self.case
        result = case.native()
    ...
    def test_invalid_or_stale_modes_reject_before_writing_and_valid_review_recovers(self):
        case = self.case
        before = case.package()
