...
Load this file only when evals run or change.

Trigger tests ask if the skill should start. Act tests check files, states, codes, and proof. They do not ask a script to rate taste.

State tests keep the product state set open. Review tests require every eye, brain, touch, objective failure, bad design, bad output, and bad practice item. Each answer needs an evidence-bound scene, observation, sources, decision, reason, alternative, and doubt. The model owns every answer and judgment.
