...
class TestReviewedRegistry(unittest.TestCase):
    ...
    def test_missing_review_rejects_before_native_formatter_and_any_file_effect(self):
    ...
    def test_native_plan_is_read_only_and_reviewed_sequence_preserves_modes(self):
        native_formatter(self.repo)
    ...
    def test_skipping_next_file_and_stale_source_reject_without_effect_then_recover(self):
    ...
    def test_archived_identity_is_retained_and_corrupt_evidence_rejects(self):
    ...
    def test_unplanned_mode_rejects_before_effect_and_valid_review_recovers(self):
    ...
    def test_all_named_bodies_precede_source_and_metadata_effects(self):
        native_formatter(self.repo)
    ...
    def test_registry_module_dependencies_have_no_import_cycle(self):
