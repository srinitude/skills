...
def _TestCatalogReview_prepare(self):
...
def _TestCatalogReview_invoke(self, *extra, review=True):
...
def _TestCatalogReview_setUp(self):
...
def _TestCatalogReview_test_missing_review_rejects_without_file_effect(self):
...
def _TestCatalogReview_test_plan_is_read_only_and_review_mode_is_exclusive(self):
...
def _TestCatalogReview_test_current_review_preserves_mode_and_dispositions_and_rejects_stale_replay(self):
...
def _TestCatalogReview_test_invalid_source_metadata_review_and_target_reject_then_recover(self):
...
def _TestCatalogReview_test_schema_or_request_drift_restores_catalog_and_current_inputs_recover(self):
...
def _TestCatalogReview_test_malformed_schema_or_catalog_rejects_cleanly_without_effects(self):
...
def _TestCatalogReview_test_lock_blocks_effect_and_release_recovers(self):
    before = self.package()
...
class TestCatalogReview(unittest.TestCase):
    ...
    setUp = _TestCatalogReview_setUp
    prepare = _TestCatalogReview_prepare
    invoke = _TestCatalogReview_invoke
    test_missing_review_rejects_without_file_effect = _TestCatalogReview_test_missing_review_rejects_without_file_effect
    test_plan_is_read_only_and_review_mode_is_exclusive = _TestCatalogReview_test_plan_is_read_only_and_review_mode_is_exclusive
    test_current_review_preserves_mode_and_dispositions_and_rejects_stale_replay = _TestCatalogReview_test_current_review_preserves_mode_and_dispositions_and_rejects_stale_replay
    test_invalid_source_metadata_review_and_target_reject_then_recover = _TestCatalogReview_test_invalid_source_metadata_review_and_target_reject_then_recover
    test_schema_or_request_drift_restores_catalog_and_current_inputs_recover = _TestCatalogReview_test_schema_or_request_drift_restores_catalog_and_current_inputs_recover
    test_malformed_schema_or_catalog_rejects_cleanly_without_effects = _TestCatalogReview_test_malformed_schema_or_catalog_rejects_cleanly_without_effects
    test_lock_blocks_effect_and_release_recovers = _TestCatalogReview_test_lock_blocks_effect_and_release_recovers
