...
Select Continue when the installer asks for a target. Verify that the installed bytes match the canonical files under [`skills/`](../../skills/), including [`always-current-datetime`](../../skills/always-current-datetime/SKILL.md).
