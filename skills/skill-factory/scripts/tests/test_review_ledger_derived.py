...
def _TestDerivedLedger_setUp(self):
    self.data = captured_ledger()

def _TestDerivedLedger_edges(self, selector, **options):
    return view(self.data, dict(action='relations', selector=selector, **options))

def _TestDerivedLedger_test_trace_and_detail_include_derived_edges_without_transitive_truth(self):
...
def _TestDerivedLedger_test_source_structure_and_assertions_keep_identity_and_repetition(self):
...
def _TestDerivedLedger_test_declared_reading_is_distinct_from_execution(self):
...
def _TestDerivedLedger_test_missing_bindings_unknown_rules_and_reading_cycles_reject_then_recover(self):
...
def _TestDerivedLedger_test_current_import_observations_replace_old_imports_and_reject_staleness(self):
...
class TestDerivedLedger(unittest.TestCase):
    setUp = _TestDerivedLedger_setUp
    edges = _TestDerivedLedger_edges
    test_source_structure_and_assertions_keep_identity_and_repetition = _TestDerivedLedger_test_source_structure_and_assertions_keep_identity_and_repetition
    test_declared_reading_is_distinct_from_execution = _TestDerivedLedger_test_declared_reading_is_distinct_from_execution
    test_trace_and_detail_include_derived_edges_without_transitive_truth = _TestDerivedLedger_test_trace_and_detail_include_derived_edges_without_transitive_truth
    test_missing_bindings_unknown_rules_and_reading_cycles_reject_then_recover = _TestDerivedLedger_test_missing_bindings_unknown_rules_and_reading_cycles_reject_then_recover
    test_current_import_observations_replace_old_imports_and_reject_staleness = _TestDerivedLedger_test_current_import_observations_replace_old_imports_and_reject_staleness
