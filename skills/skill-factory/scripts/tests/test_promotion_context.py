...
def _TestPromotionContext_test_scaffold_source_and_body_review_drift_withdraw_output_and_recover(self):
...
def _TestPromotionContext_test_standardization_body_review_drift_restores_target_and_recovers(self):
...
def _TestPromotionContext_test_variant_body_review_drift_withdraws_output_and_recovers(self):
...
class TestPromotionContext(unittest.TestCase):
    test_scaffold_source_and_body_review_drift_withdraw_output_and_recover = _TestPromotionContext_test_scaffold_source_and_body_review_drift_withdraw_output_and_recover
    test_standardization_body_review_drift_restores_target_and_recovers = _TestPromotionContext_test_standardization_body_review_drift_restores_target_and_recovers
    test_variant_body_review_drift_withdraws_output_and_recovers = _TestPromotionContext_test_variant_body_review_drift_withdraws_output_and_recovers
