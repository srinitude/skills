...
- exactly five unique `CRV-###` cases across every declared group;
...
2. Permit only read-only review and named-source reads. Block external writes and any merge action.
