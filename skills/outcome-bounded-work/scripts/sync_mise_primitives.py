...
Usage: sync_mise_primitives.py [skill-root] [--check]
Exit codes: 0 current or updated, 1 stale in check mode, 2 input failure.
Example: sync_mise_primitives.py . --check
"""
import argparse
import datetime
import hashlib
...
def main(argv=None):
    ...
    print(f"Mise primitive catalog: updated {version}; dispositions unchanged")
    return 0
