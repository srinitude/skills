...
Use the public meaning-preserving rewrite skill for clause mapping when available. If a required exact host contract has no public or internal equivalent, return `BLOCKED_DEPENDENCY` rather than inventing behavior.
