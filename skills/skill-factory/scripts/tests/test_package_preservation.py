...
class TestPackagePreservation(unittest.TestCase):
    ...
    def test_promotion_moves_unowned_state_without_copying_or_losing_it(self):
    ...
    def test_unowned_collision_restores_prior_moves_and_original_target(self):
    ...
    def test_live_guard_runs_under_lock_before_any_directory_move(self):
    ...
    def test_empty_directories_and_directory_permissions_are_preserved(self):
    ...
    def test_failed_restoration_retains_backup_for_real_recovery(self):
