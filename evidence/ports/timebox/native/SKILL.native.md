...
metadata:
  hermes:
    tags: [timebox, deadline, execution, validation]
    related_skills: [always-current-datetime, starting-point, outcome-bounded-work, logic-audit]
    created_by: agent
    source: user
    created_with_hermes_commit: 33f8e96a72945afb29f3bc9ef9991940f0bedcf7
...
`PD-101`: `references/eval-cases.json` owns objective pressure cases and acceptance. Load it before testing, reviewing, or changing this skill. This file owns runtime behavior and links to that evaluation owner.
