...
```text
$ python3 scripts/tool_call_config.py generate @evals/fixtures/established-mcp-read.json --behavior @evals/fixtures/behavior-report.json --output ../../.artifacts/tool-call-configuration-for/fixture-read
