...
def _TestLedgerBootstrap_bootstrap(self):
...
def _TestLedgerBootstrap_test_public_bootstrap_reads_reviewed_body_without_installing_it(self):
...
def _TestLedgerBootstrap_test_stale_or_unfinished_body_review_rejects_without_writes_then_recovers(self):
    candidate, review, value = self.bootstrap()
    before = self.package()
...
def _TestLedgerBootstrap_test_bootstrap_cannot_replace_or_hide_an_installed_body(self):
...
def _TestLedgerBootstrap_test_bootstrap_body_or_review_cannot_be_the_written_file(self):
...
def _TestLedgerBootstrap_test_missing_blank_or_invalid_candidate_rejects_then_recovers(self):
    candidate, review, value = self.bootstrap()
...
def _TestLedgerBootstrap_test_review_drift_after_creation_restores_the_file_then_recovers(self):
...
class TestLedgerBootstrap(unittest.TestCase):
    ...
    bootstrap = _TestLedgerBootstrap_bootstrap
    test_public_bootstrap_reads_reviewed_body_without_installing_it = _TestLedgerBootstrap_test_public_bootstrap_reads_reviewed_body_without_installing_it
    test_stale_or_unfinished_body_review_rejects_without_writes_then_recovers = _TestLedgerBootstrap_test_stale_or_unfinished_body_review_rejects_without_writes_then_recovers
    test_bootstrap_cannot_replace_or_hide_an_installed_body = _TestLedgerBootstrap_test_bootstrap_cannot_replace_or_hide_an_installed_body
    test_bootstrap_body_or_review_cannot_be_the_written_file = _TestLedgerBootstrap_test_bootstrap_body_or_review_cannot_be_the_written_file
    test_missing_blank_or_invalid_candidate_rejects_then_recovers = _TestLedgerBootstrap_test_missing_blank_or_invalid_candidate_rejects_then_recovers
    test_review_drift_after_creation_restores_the_file_then_recovers = _TestLedgerBootstrap_test_review_drift_after_creation_restores_the_file_then_recovers
