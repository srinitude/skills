...
The Skills Hub tap is the primary route for this skill collection. [`skills.sh.json`](../../skills.sh.json) groups every canonical skill under [`skills/`](../../skills/), including [`outcome-bounded-work`](../../skills/outcome-bounded-work/SKILL.md).
