...
class TestStandardizationLedgerBody(unittest.TestCase):
    def test_complete_current_ledger_blocks_precede_domain_action(self):
    ...
    def test_custom_ledger_policy_requires_explicit_migration(self):
    ...
    def test_stale_relation_table_cannot_hide_behind_its_current_heading(self):
    ...
    def test_complete_rewrite_cycle_keeps_current_policies_and_owner_links(self):
    ...
    def test_owner_links_do_not_invent_executable_tasks_on_the_next_update(self):
        profile = {'primary_term': 'clock anchor', 'main_task': 'anchor', 'outcome': DOMAIN}
    ...
    def test_quoted_policy_examples_do_not_become_operative_rules(self):
