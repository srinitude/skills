...
def _TestTemplateDependencyOrder_test_foundation_and_plan_precede_development_and_acceptance(self):
...
def _TestTemplateDependencyOrder_test_preconditions_are_owned_before_the_numbered_consumers(self):
    text = TEMPLATE.read_text(encoding='utf-8')
...
def _assert_relations(self, path, initial):
...
class TestTemplateDependencyOrder(unittest.TestCase):
    test_foundation_and_plan_precede_development_and_acceptance = _TestTemplateDependencyOrder_test_foundation_and_plan_precede_development_and_acceptance
    test_preconditions_are_owned_before_the_numbered_consumers = _TestTemplateDependencyOrder_test_preconditions_are_owned_before_the_numbered_consumers
    test_complete_relationship_vocabulary_is_in_both_initial_bodies = _TestTemplateDependencyOrder_test_complete_relationship_vocabulary_is_in_both_initial_bodies
