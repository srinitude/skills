...
def _TestVariantAcceptance_test_both_directions_preserve_source_and_execute_adapted_behavior(self):
...
def _TestVariantAcceptance_test_failed_candidate_does_not_touch_source_or_destination(self):
    with tempfile.TemporaryDirectory() as temp:
        base = Path(temp)
...
class TestVariantAcceptance(unittest.TestCase):
    test_both_directions_preserve_source_and_execute_adapted_behavior = _TestVariantAcceptance_test_both_directions_preserve_source_and_execute_adapted_behavior
    test_failed_candidate_does_not_touch_source_or_destination = _TestVariantAcceptance_test_failed_candidate_does_not_touch_source_or_destination
