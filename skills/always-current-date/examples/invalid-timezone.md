...
Prove that an invalid configured timezone fails closed instead of producing a guessed date.

## Command

```bash
python3 "$SKILL_DIR/scripts/current_anchor.py" --timezone Not/A_Zone
```
...
Verification: no success object or dated prefix was emitted, and date-dependent work remained blocked.
