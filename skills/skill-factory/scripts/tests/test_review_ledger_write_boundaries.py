...
def _TestWriteBoundaries_test_body_case_aliases_are_rejected_as_body_paths(self):
    before = self.package()
...
def _TestWriteBoundaries_test_source_alias_uses_actual_file_identity_and_preserves_the_original(self):
...
class TestWriteBoundaries(unittest.TestCase):
    ...
    test_body_case_aliases_are_rejected_as_body_paths = _TestWriteBoundaries_test_body_case_aliases_are_rejected_as_body_paths
    test_source_alias_uses_actual_file_identity_and_preserves_the_original = _TestWriteBoundaries_test_source_alias_uses_actual_file_identity_and_preserves_the_original
