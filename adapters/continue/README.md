...
Select Continue when the installer asks for a target. Verify that the installed bytes match [`skills/starting-point/SKILL.md`](../../skills/starting-point/SKILL.md).
