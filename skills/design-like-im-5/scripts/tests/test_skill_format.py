...
TEXT_CASES = [
    ("Make a full product", "\tMake a full product", "tab characters"),
    ("for the full support chain.\n", "for the full support chain.  \n",
     "trailing whitespace"),
    ...
    ("Make a full product that feels clear, able, and easy to use.",
     "::client-only{Make a full product that feels clear.}",
     "client-specific directives"),
    ("Make a full product that feels clear, able, and easy to use.",
     "<client-widget>Make a full product.</client-widget>", "raw HTML"),
    ("Make a full product that feels clear, able, and easy to use.",
