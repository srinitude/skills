...
class TestFormatterPermissions(unittest.TestCase):
    ...
    def test_native_stdin_formatting_returns_bytes_without_changing_target(self):
    ...
    def test_config_write_rejects_without_mutation_and_static_recovery_formats(self):
    ...
    def test_nested_configuration_drift_invalidates_its_consumer(self):
