...
Select Continue when the installer asks for a target. Verify that the installed bytes match [`skills/reify/SKILL.md`](../../skills/reify/SKILL.md), [`skills/starting-point/SKILL.md`](../../skills/starting-point/SKILL.md), and [`skills/skill-factory/SKILL.md`](../../skills/skill-factory/SKILL.md).
