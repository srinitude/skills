...
def _TestStandardizationBoundaries_setUp(self):
...
def _TestStandardizationBoundaries_guarded_attempt(self):
...
def _TestStandardizationBoundaries_test_review_flags_have_one_grammar(self):
...
def _TestStandardizationBoundaries_test_profile_byte_drift_rejects_before_stage_then_recovers(self):
...
def _TestStandardizationBoundaries_test_file_and_directory_mode_drift_reject_before_stage(self):
...
def _TestStandardizationBoundaries_test_last_file_and_initial_body_reviews_reject_before_stage(self):
...
class TestStandardizationBoundaries(unittest.TestCase):
    setUp = _TestStandardizationBoundaries_setUp
    guarded_attempt = _TestStandardizationBoundaries_guarded_attempt
    test_profile_byte_drift_rejects_before_stage_then_recovers = _TestStandardizationBoundaries_test_profile_byte_drift_rejects_before_stage_then_recovers
    test_file_and_directory_mode_drift_reject_before_stage = _TestStandardizationBoundaries_test_file_and_directory_mode_drift_reject_before_stage
    test_last_file_and_initial_body_reviews_reject_before_stage = _TestStandardizationBoundaries_test_last_file_and_initial_body_reviews_reject_before_stage
    test_review_flags_have_one_grammar = _TestStandardizationBoundaries_test_review_flags_have_one_grammar
