...
def _TestWorkViews_test_work_preserves_entire_method_context_and_unaccepted_relationships(self):
...
def _TestWorkViews_test_file_impact_preserves_old_current_and_missing_owners_without_live_claims(self):
...
def _TestWorkViews_test_missing_or_invalid_review_contract_rejects_without_mutation_and_recovers(self):
    invalid = []
...
def _TestWorkViews_test_native_work_and_impact_reject_wrong_options_and_recover(self):
...
def _TestWorkViews_test_public_work_reads_the_whole_current_body_and_does_not_execute_the_method(self):
    original = self.ledger.read_bytes()
...
class TestWorkViews(unittest.TestCase):
    ...
    setUp = _TestWorkViews_setUp
    test_work_preserves_entire_method_context_and_unaccepted_relationships = _TestWorkViews_test_work_preserves_entire_method_context_and_unaccepted_relationships
    test_file_impact_preserves_old_current_and_missing_owners_without_live_claims = _TestWorkViews_test_file_impact_preserves_old_current_and_missing_owners_without_live_claims
    test_missing_or_invalid_review_contract_rejects_without_mutation_and_recovers = _TestWorkViews_test_missing_or_invalid_review_contract_rejects_without_mutation_and_recovers
    test_native_work_and_impact_reject_wrong_options_and_recover = _TestWorkViews_test_native_work_and_impact_reject_wrong_options_and_recover
    test_public_work_reads_the_whole_current_body_and_does_not_execute_the_method = _TestWorkViews_test_public_work_reads_the_whole_current_body_and_does_not_execute_the_method
