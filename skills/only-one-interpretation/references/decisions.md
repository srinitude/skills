...
- 2026-08-30: Kept semantic judgment in the runtime instructions and made `scripts/validate_result.py` an optional record checker, because deterministic equality and trace checks cannot prove language uniqueness.
