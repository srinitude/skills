...
metadata:
  hermes:
    tags: [deduplication, data-quality, files, records, urls, skills]
    related_skills: [always-current-datetime, starting-point, outcome-bounded-work, logic-audit]
    created_with_hermes_commit: a991dfc25daf68994c21d6adcdfbafb1b3dc23cf
    compatibility_reviewed_with_hermes_commit: a991dfc25daf68994c21d6adcdfbafb1b3dc23cf
---
...
- `PD-001`: `references/core-contract.md` owns the full report, canonical-selection, authority, and verification contract. Load it for every inspection or apply command. This section is its backlink.
