...
test('groups canonical skills for skills-hub clients', async () => {
  expect(await json('skills.sh.json')).toEqual({
    ...
    groupings: [
      {
        skills: ['would-agents-actually', 'would-humans-actually'],
      ...
      {
        skills: ['only-one-interpretation', 'prompt-enhancer'],
        title: 'Prompt Quality',
      },
      { skills: ['logic-audit'], title: 'Reasoning' },
      {
        skills: ['simplify-skill', 'skill-factory', 'tool-call-configuration-for'],
