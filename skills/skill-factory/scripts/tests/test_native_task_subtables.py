...
class TestNativeTaskSubtables(unittest.TestCase):
    def test_native_domain_environment_subtable_is_preserved(self):
    ...
    def test_quoted_task_names_keep_their_subtable_owner(self):
    ...
    def test_helper_subtable_environment_is_checked_before_replacement(self):
    ...
    def test_dependency_rewrite_does_not_write_into_ci_environment(self):
