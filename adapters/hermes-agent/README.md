...
The Skills Hub tap is the primary route for this skill collection. [`skills.sh.json`](../../skills.sh.json) groups the canonical [`starting-point` SKILL.md](../../skills/starting-point/SKILL.md).
