...
7. **Tool arguments:** Date-sensitive actions use absolute dates and timezone when supported.
8. **Visible output:** The daily header and dated prefix follow the local-date rules and persist in the actual reply.
9. **Failure:** Invalid or unavailable time blocks date-dependent work with the stable marker.
